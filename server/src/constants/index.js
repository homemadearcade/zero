...
export const ENTITY_CLASS_LIBRARY_ID_PREFIX = 'ecl-';
export const RELATION_TAG_LIBRARY_ID_PREFIX = 'rtl-';
export const RELATION_LIBRARY_ID_PREFIX = 'rl-';
export const EVENT_LIBRARY_ID_PREFIX = 'evl-';
export const EFFECT_LIBRARY_ID_PREFIX = 'efl-';
