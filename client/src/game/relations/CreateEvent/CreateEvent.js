...
const CreateEvent = ({ closeCreateEvent, editGameModel, updateCreateEvent, gameFormEditor: { relation }, gameModel: { gameModel} }) => {
  ...
  useEffect(() => {
    if(!relation.relationId) {
      updateCreateEvent({ relationId: RELATION_ID_PREFIX+generateUniqueId(), isNew: true })
    }
  }, [])
