...
const ContextMenus = ({ contextMenu, remoteContextMenu, cobrowsing : { isActivelyCobrowsing }}) => {  
  ...
  function renderContextMenus() {
    ...
    if(contextMenu.isContextMenuOpen) {
      const { isContextMenuOpen, entityInstanceIdSelectedContextMenu, entityClassIdSelectedContextMenu, selectableObjectInstances, contextMenuX, contextMenuY } = contextMenu
      ...
      contextMenus.push(<ContextMenu  key="contextmenu"  contextMenuX={contextMenuX} contextMenuY={contextMenuY} isOpen={isContextMenuOpen}>
        <GameContextMenuBody entityInstanceIdSelectedContextMenu={entityInstanceIdSelectedContextMenu} entityClassIdSelectedContextMenu={entityClassIdSelectedContextMenu} selectableObjectInstances={selectableObjectInstances}/>
      </ContextMenu>)
    }
    ...
    //   const { isContextMenuOpen, entityInstanceIdSelectedContextMenu, entityClassIdSelectedContextMenu, selectableObjectInstances, contextMenuX, contextMenuY} = remoteContextMenu
