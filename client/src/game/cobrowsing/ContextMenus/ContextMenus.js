...
const ContextMenus = ({ contextMenu, remoteContextMenu, cobrowsing : { isActivelyCobrowsing }}) => {  
  ...
  function renderContextMenus() {
    ...
    if(contextMenu.isContextMenuOpen) {
      const { isContextMenuOpen, instanceIdSelectedContextMenu, classIdSelectedContextMenu, selectableObjectInstances, contextMenuX, contextMenuY } = contextMenu
      ...
      contextMenus.push(<ContextMenu  key="contextmenu"  contextMenuX={contextMenuX} contextMenuY={contextMenuY} isOpen={isContextMenuOpen}>
        <GameContextMenuBody instanceIdSelectedContextMenu={instanceIdSelectedContextMenu} classIdSelectedContextMenu={classIdSelectedContextMenu} selectableObjectInstances={selectableObjectInstances}/>
      </ContextMenu>)
    }
    ...
    //   const { isContextMenuOpen, instanceIdSelectedContextMenu, classIdSelectedContextMenu, selectableObjectInstances, contextMenuX, contextMenuY} = remoteContextMenu
