...
import { DEFAULT_TEXTURE_ID, ON_SPAWN, BOUNDARY_COLLIDE, BOUNDARY_WRAP, MOVEMENT_TURN_ON_COLLIDE, MOVEMENT_FOLLOW_PLAYER, OBJECT_CLASS, PLAYER_CLASS, ZONE_CLASS, NPC_CLASS, PLAYER_INSTANCE_ID_PREFIX, BACKGROUND_CANVAS_ID, BACKGROUND_CANVAS_DEPTH, PLAYGROUND_CANVAS_ID, PLAYGROUND_CANVAS_DEPTH, FOREGROUND_CANVAS_ID, FOREGROUND_CANVAS_DEPTH, ON_INTERACT, ON_DESTROY_ONE, ON_DESTROY_ALL, EFFECT_COLLIDE, NPC_INSTANCE_CANVAS_ID, OBJECT_INSTANCE_CANVAS_ID, PLAYER_INSTANCE_CANVAS_ID } from "../constants";
...
export class ObjectInstance extends Sprite {
  ...
  getObjectGroup(objectClass) {
    ...
    if(objectClass.type === OBJECT_CLASS) {
      return OBJECT_INSTANCE_CANVAS_ID
    }
