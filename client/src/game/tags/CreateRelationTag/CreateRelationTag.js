...
import { DATA_SOURCE_AUTOGENERATED, RELATION_TAG_ID_PREFIX } from '../../constants';
...
const CreateRelationTag = ({ updateCreateRelationTag, closeCreateRelationTag, editGameModel, gameFormEditor: { relationTag }, gameModel: { gameModel } }) => {
  ...
  return <CobrowsingModal open onClose={handleClose}>
    <div className="CreateRelationTag">
      ...
      />
      <Button disabled={relationTag.error || !relationTag.textureTint || relationTag.dataSource === DATA_SOURCE_AUTOGENERATED} type="submit" onClick={handleSubmit}>Save</Button>
    </div>
  </CobrowsingModal>
}
