...
export const EFFECT_TRANSFORM_TEMPORARY_START = 'EFFECT_TRANSFORM_TEMPORARY_START'
export const EFFECT_TRANSFORM_TEMPORARY_END = 'EFFECT_TRANSFORM_TEMPORARY_END'
...
export const EFFECT_SPEED_UP_CURRENT_DIRECTON = 'EFFECT_SPEED_UP_CURRENT_DIRECTON'
...
export const EFFECT_OPEN_TRANSITION = 'EFFECT_OPEN_TRANSITION'
export const EFFECT_CLOSE_TRANSITION = 'EFFECT_CLOSE_TRANSITION'

export const EFFECT_GRAVITY_PULL = 'EFFECT_GRAVITY_PULL'
export const EFFECT_GRAVITY_PUSH = 'EFFECT_GRAVITY_PUSH'

export const EFFECT_ALLOW_CLIMB = 'EFFECT_ALLOW_CLIMB'
...
export const EFFECT_END_GAME = 'EFFECT_END_GAME'
