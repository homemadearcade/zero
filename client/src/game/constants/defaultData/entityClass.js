...
export const ENTITY_CLASS_SOURCE_GLOBAL_LIBRARY = 'ENTITY_CLASS_SOURCE_GLOBAL_LIBRARY'
export const ENTITY_CLASS_SOURCE_USER_LIBRARY = 'ENTITY_CLASS_SOURCE_USER_LIBRARY'
export const ENTITY_CLASS_SOURCE_AUTOGENERATED = 'ENTITY_CLASS_SOURCE_AUTOGENERATED'
export const ENTITY_CLASS_SOURCE_GAME_MODEL = 'ENTITY_CLASS_SOURCE_GAME_MODEL'
...
export const defaultClass = {
  entityClassSource: ENTITY_CLASS_SOURCE_GAME_MODEL,
  // lastSelectedDate: 0,
  lastEditedDate: 0,
  isRemoved: false,
