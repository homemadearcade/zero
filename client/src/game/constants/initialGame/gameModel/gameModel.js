...
import { CAMERA_ZONE_ENTITY_IVID, DIRECTIONAL_PLAYER_ENTITY_IVID, END_GAME_CUTSCENE_IVID, INITIAL_STAGE_IVID, JUMPER_PLAYER_ENTITY_IVID, PLAYER_SPAWN_ZONE_ENTITY_IVID, PLAYTHROUGH_START_CUTSCENE_IVID, STAGE_ZONE_ENTITY_IVID, SWIMMER_PLAYER_ENTITY_IVID, VEHICLE_PLAYER_ENTITY_IVID, importantValueData, importantValueIdsList } from "../importantValueIds";
...
export function createInitialGameModel() {
  ...
  console.log(createInitialPlayerEntities(importantValues))

  const initialStage = createInitialStage(importantValues)

  console.log( {    vehicleEntity,jumperEntity, directionalEntity,
      swimmerEntity
  })
