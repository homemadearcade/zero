...
export function enrichGameModel(gameData) {
  ...
  Object.keys(effectEditInterfacess).forEach((effectBehavior) => {
    const effectEditInterfaces = effectEditInterfacess[effectBehavior]
    if(effectEditInterfaces.isStandalone) {
