...
import { addAutogeneratedClassesToGameModel, addDefaultsToGameModel, addLibraryToGameModel, cleanGameModel, enrichGameModel } from '../../../autogeneration/gameModel';
...
export function onArcadeGameModelUpdate(gameUpdate) {
  ...
  addAutogeneratedClassesToGameModel(gameUpdate)
...
function loadArcadeGame(response, dispatch) {
  ...
  addAutogeneratedClassesToGameModel(gameData)
