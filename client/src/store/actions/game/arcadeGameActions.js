...
import { 
    ...
    initialBackgroundLayerId, initialForegroundLayerId, initialPlaygroundLayerId, initialStageId, 
...
import { BACKGROUND_LAYER_GROUP_IID, DATA_SOURCE_SYSTEM_IID, FOREGROUND_LAYER_GROUP_IID, PLAYGROUND_LAYER_GROUP_IID } from '../../../constants/interfaceIds';
...
export function onArcadeGameModelUpdate(gameUpdate) {
  ...
  generateActionEffects(gameUpdate)
...
async function loadArcadeGame(response, dispatch) {
...
export async function addLayersForArcadeGameStage(arcadeGameMongoId, userMongoId, stageId) {
  const backgroundTextureId = getTextureIdForLayerId(arcadeGameMongoId, stageId, initialBackgroundLayerId)
  const playgroundTextureId = getTextureIdForLayerId(arcadeGameMongoId, stageId, initialPlaygroundLayerId)
  const foregroundTextureId = getTextureIdForLayerId(arcadeGameMongoId, stageId, initialForegroundLayerId)
  ...
  store.dispatch(editArcadeGame(arcadeGameMongoId, {
    stages: {
      [stageId] : {
        layers: {
          [initialBackgroundLayerId]: {
            textureId: backgroundTextureId,
            name: 'Background',
            layerId: initialBackgroundLayerId,
            layerGroupIID: BACKGROUND_LAYER_GROUP_IID,
            dataSourceIID: DATA_SOURCE_SYSTEM_IID
          },
          [initialPlaygroundLayerId]: {
            textureId: playgroundTextureId,
