...
import { addGameEffectsToExperienceModel } from '../experience/experienceModelActions';
...
async function loadArcadeGame(response, dispatch) {
  ...
  if(store.getState().experienceModel.experienceModel) {
    const experienceModel = store.getState().experienceModel.experienceModel
