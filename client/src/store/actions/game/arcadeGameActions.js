...
import { generateUniqueId, getImageUrlFromTextureId, getTextureIdForLayerId } from '../../../utils';
...
export async function addLayersForArcadeGameStage(arcadeGameMongoId, userMongoId, stageId) {
  ...
  await store.dispatch(addCanvasImage({
    ...
    imageUrl: getImageUrlFromTextureId(backgroundLayerId),
    imageData: {
      width: gameWidth,
      height: gameHeight,
    },
    textureId: backgroundLayerId, 
    userMongoId,
    visualTags: ['Layer'],
  }))
  ...
  await store.dispatch(addCanvasImage({
    ...
    imageUrl: getImageUrlFromTextureId(playgroundLayerId),
    textureId: playgroundLayerId, 
    userMongoId,
    visualTags: ['Layer'],
  }))
  ...
  await store.dispatch(addCanvasImage({
    ...
    imageUrl: getImageUrlFromTextureId(foregroundLayerId),
    textureId: foregroundLayerId,
    userMongoId,
    visualTags: ['Layer'],
  }))
