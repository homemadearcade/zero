...
const PlayGamePage = ({ match }) => {
  return (
    <div className="PlayGamePage">
      <LocalGameRoomContext room={{gameStatus: PLAYTHROUGH_START_STATE, arcadeGameMongoId: match.params.arcadeGameMongoId}}>
        <GameView/>
...
export default compose(
  requireChrome,
  withRouter,
  connect(mapStateToProps, { requestFullscreen, changeGameStatus, unloadArcadeGame })
)(PlayGamePage);
