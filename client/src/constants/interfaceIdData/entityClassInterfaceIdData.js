import { BASIC_CLASS_ADD_IID, BASIC_CLASS_CONTAINER_IID, BASIC_CLASS_SELECT_IID, CHANGE_CLASS_TYPE_IID, CLASS_LAYER_IID, CLASS_LOCK_IID, CLASS_RELATION_TAGS_IID, CLASS_UNLOCKABLE_IID, CLASS_VISIBILITY_IID, NPC_CLASS_ADD_IID, NPC_CLASS_CONTAINER_IID, NPC_CLASS_SELECT_IID, PLAYER_CLASS_ADD_IID, PLAYER_CLASS_CONTAINER_IID, PLAYER_CLASS_SELECT_IID, POWERUP_CLASS_ADD_IID, POWERUP_CLASS_CONTAINER_IID, POWERUP_CLASS_SELECT_IID, ZONE_CLASS_ADD_IID, ZONE_CLASS_CONTAINER_IID, ZONE_CLASS_SELECT_IID } from "../interfaceIds";
...
export default {
  ...
  [POWERUP_CLASS_CONTAINER_IID]: {
    ignoreTools: true
  },
  [POWERUP_CLASS_SELECT_IID]: {},
  [POWERUP_CLASS_ADD_IID]: {
