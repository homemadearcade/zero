...
import { 
  DATA_SOURCE_AUTOGENERATED_IID, DATA_SOURCE_IMPORTED_GAME_MODEL_IID, 
  DATA_SOURCE_ENTITY_MODEL_IID, IS_DATA_REMOVED_IID, 
  RELATION_TAG_LIST_IID, SELECT_RELATION_TAG_IID, 
  DATA_SOURCE_SYSTEM_IID, DATA_SOURCE_ACTION_IID, 
...
function DataSourceVisibilityMenu({ interfaceId, gameSelector: { selectorInterfaceListInvisibility }, toggleSelectorClassInvisibility, cobrowsing: { isActivelyCobrowsing, isSubscribedCobrowsing } }) {
  ...
  function getSelectorListVisibility() {
    ...
    // if(interfaceId !== DIALOGUE_IID && interfaceId !== CUTSCENE_IID) {
      ...
      menuItems.push(
        <MenuItem key={DATA_SOURCE_IMPORTED_GAME_MODEL_IID+interfaceId} dense>{renderSelectorListCheckbox(DATA_SOURCE_IMPORTED_GAME_MODEL_IID)}</MenuItem>
      )
      menuItems.push(
