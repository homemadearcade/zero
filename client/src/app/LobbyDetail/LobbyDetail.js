    ...
    <div className="LobbyDetail">
      ...
      <div className="LobbyDetail__roles">
        ...
        <Typography component="div" variant="subtitle1">Game Host:</Typography>
          ...
          {lobby.gameHostId && usersById[lobby.gameHostId] && <UserStatus myTracks={myTracks} userTracks={userTracks} userId={usersById[lobby.gameHostId]?.id}/>}
        ...
        <div className="LobbyDetail__role">
          ...
          {lobby.participantId && usersById[lobby.participantId] && <UserStatus myTracks={myTracks} userTracks={userTracks} userId={usersById[lobby.participantId]?.id}/>}
        ...
        <div className="LobbyDetail__role">
          ...
          {lobby.guideId && usersById[lobby.guideId] && <UserStatus myTracks={myTracks} userTracks={userTracks} userId={usersById[lobby.guideId]?.id}/>}
        ...
        <div className="LobbyDetail__others">
          ...
          {lobby.users.filter((user) => {
            ...
            return true
          }).length === 0 && <Typography component="div" variant="subtitle2">No one watching</Typography>}
